...
use App\Form\ResourceAccessLevelType;
...
class ResourceAccessLevelController extends AbstractController
{
    ...
    {
        $list = $entityManager->getRepository(ResourceAccessLevel::class)->findAll();

        return $this->render('admin/resource/access_level/list.html.twig', ['list' => $list]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        $form = $this->createForm(ResourceAccessLevelType::class, $object)
     ...
     */
    public function edit(Request $request, ResourceAccessLevel $object): Response
    {
        $form = $this->createForm(ResourceAccessLevelType::class, $object);
        $form->handleRequest($request);
     ...
     */
    public function delete(Request $request, ResourceAccessLevel $object): Response
    {
